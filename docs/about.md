<div class="about-header">
  <img src="assets/profile.jpg" alt="Portrait of Piero Gasparotto" class="about-avatar" width="160" height="160" loading="lazy" />
  ...
  <a href="https://scholar.google.com/citations?user=fMBHbINKqfsFsx7Wg" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
    ...
    <span>Piero Gasparotto - Google Scholar</span>
  </a>
